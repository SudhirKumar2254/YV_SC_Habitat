namespace Sitecore.Foundation.SitecoreExtensions.Services
{
    ...
    public class TrackerService : ITrackerService
    {
        ...
        public void IdentifyContact(string source, string identifier)
        {
            ...
            Sitecore.Analytics.Tracking.Identification.IdentificationResult result = identificationManager.IdentifyAs(new Sitecore.Analytics.Tracking.Identification.KnownContactIdentifier(source, identifier));
        }
    }
}